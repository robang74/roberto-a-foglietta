...
Published Oct 7, 2023 - origin LinkedIn

- **Updated on 2023.10.07** - Questo articolo comincia con una citazione che sembra tratta dalle favole del buon selvaggio e strumentalmente esposta sullo scafale del sapere alternativo. Invece "ubuntu"è una parola che esiste davvero e ha davvero quel signifcato, motivo per il quale Ubuntu Linux, la distribuzione sud-africana, probabilmente la più apprezzata al mondo, si chiama proprio così.
...
Quindi riguardo al concetto di Ubuntu possiamo dire che esso riguarda la solidarietà. Ma non è solo questo perché c'è dell'altro: 
