...
La cosa più interessante è che il debito pubblico americano è già tecnicamente fallito

=-> lnkd.in/dhMVt9kC

che è il motivo per il quale paradossalmente ora tutti i dollari sono costretti ad essere investiti in USA, quindi gli USA sono in saldo. A noi europei toccherà la stessa sorte oppure la guerra contro qualcuno che ci rada al suolo e cancelli il ricordo del debito (default reset), tipo la Russia.

=-> lnkd.in/dYa874ud

Esiste una via di uscita che non sia la WW3, ma la BCE imita la FED e non c'è un 2° posto sul podio degli schemi Ponzi.
