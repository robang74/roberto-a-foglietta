...
- sezione scritta a partire dal [post #5](https://www.linkedin.com/posts/robertofoglietta_introduzione-alla-politica-lezione-di-base-activity-7379881971449061376-_l5t) pubblicato su LinkedIn lo stesso giorno.

- sezione che fa riferimento al discorso registrato in questo [video](https://www.facebook.com/plugins/video.php?height=476&href=https%3A%2F%2Fwww.facebook.com%2Freel%2F806567755662149%2F&show_text=false&width=382&t=0) in cui una parlamentare del M5S accusa il governo Meloni di truffa sulle statistiche manipolate relative alle liste d'attesa dei CUP.
...
Giusto per ricordare, ancora una volta, fra nozioni (sapere, ripetere un discorso) e capire (collegare le idee in modo funzionale). Perché questa differenza è sottile ma determinante? Perché se questa persona dovesse sostenere un dibattito live, non potrebbe reggere il confronto con qualcuno che comprende la sostanza di ciò che dice. Irrilevante, tanto **non** si confrontano con quelli che comprendono e la gente **non** vota in base a questa discriminante. Eppure è l'unica discriminante che fa la differenza fra un buone governo (o una buona direzione aziendale) e un cattivo governo (anche qualora supportato da buone intenzioni).
